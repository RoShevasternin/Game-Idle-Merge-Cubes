...
class ADialogOfflineReward(override val screen: AdvancedScreen): AdvancedGroup() {
    ...
    private val offlineTime = 3
    private val timeUnits   = "HOURS"

    private val textTitle    = "YOU’VE BEEN AWAY FOR $offlineTime $timeUnits!"
    ...
    private fun addTitleLbl() {
        addActor(aTitleLbl)
        aTitleLbl.setBounds(94f, 1120f, 1706f, 382f)
