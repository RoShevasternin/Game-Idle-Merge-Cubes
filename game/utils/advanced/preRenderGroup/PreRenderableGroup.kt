...
abstract class PreRenderableGroup: AdvancedGroup(), PreRenderable {
    ...
    override fun draw(batch: Batch?, parentAlpha: Float) {
        ...
        //TODO: Якщо не працює ShaderBlur то проблема тут в передачі alpha
    ...
    override fun preRender(batch: Batch, parentAlpha: Float) {
        ...
        batch.begin()
        preRenderChildren(batch, parentAlpha)
        batch.end()
    ...
    private fun preRenderChildren(batch: Batch, parentAlpha: Float) {
        ...
        for (i in 0 until children.size) {
            ...
            //TODO: Якщо не працює ShaderBlur то проблема тут в передачі alpha
            renderPreRenderables(child, batch, parentAlpha /*stage.root.color.a*/)
        }
        children.end()
    }
